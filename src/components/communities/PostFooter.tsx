...
const PostFooter = ({ AddImage }: Props) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 flex justify-center">
      <div className="w-full max-w-[500px] h-[100px] bg-[#FAFAFA] flex items-center px-5 pb-5 shadow-[0_-4px_10px_rgba(85,85,85,0.1)] rounded-t-lg">
        <svg
          width="30"
          height="27"
          viewBox="0 0 30 27"
