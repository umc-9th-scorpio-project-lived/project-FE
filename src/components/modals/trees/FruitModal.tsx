...
import type { RoutineYearMonth } from '@/types/statistics/Statistics.types';
...
const FruitModal = ({ routineYearMonth }: Props) => {
    ...
    <div className="w-full bg-screen-0 rounded-2xl pt-6.5 px-4 pb-7 flex flex-col gap-5.5 relative">
      ...
      <div className="flex flex-col gap-2">
        <div className="flex justify-between">
          ...
          <div className="typo-body_reg12 text-gray-900">{`${data?.achievementRate}%`}</div>
        </div>
