  ...
  return (
    <>
      <ModalBackground>
        ...
        {modalType === 'setRepeatCycleModal' && (
          <SetRepeatCycleModal {...(modalProps ?? {})} />
        )}
        {modalType === 'setAlarmModal' && (
          <SetAlarmModal {...(modalProps ?? {})} />
        )}
        {modalType === 'selectIconModal' && (
        ...
        {modalType === 'setTrackerMonthModal' && (
          <SetTrackerMonthModal {...(modalProps ?? {})} />
        )}
        {modalType === 'setBirthModal' && (
          <SetBirthModal {...(modalProps ?? {})} />
        )}
      </ModalBackground>
    </>
  );
