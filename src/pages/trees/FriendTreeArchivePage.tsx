...
import { getFriendTreeArchive } from '@/services/friends/getFriendTreeArchive';
...
const FriendTreeArchivePage = () => {
  ...
  const {
    ...
    queryKey: [friendId, 'friendTreeArchive'],
    queryFn: ({ pageParam }) =>
      getFriendTreeArchive({
...
export default FriendTreeArchivePage;
