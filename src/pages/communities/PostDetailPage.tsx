...
import { getPostDetail } from "@/services/posts/post";
      ...
      <div className="flex flex-col px-4 py-3 gap-2 border-b-2 border-gray-100">
        <div className="flex items-center gap-2.5">
          ...
          <div className="flex flex-col gap-0.5">
            <span className="typo-body_reg16 text-gray-900">{post?.author.nickname}</span>
            <div className="flex items-center gap-1">
              <span className="typo-body_reg12 text-gray-600">{post?.categoryLabel}</span>
              <div className="w-0.5 h-0.5 bg-[#9C9C9C]" />
              <span className="typo-body_reg12 text-gray-400">조회 {post?.viewCount}</span>
              <div className="w-0.5 h-0.5 bg-[#9C9C9C]" />
