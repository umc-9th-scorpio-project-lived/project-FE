...
const RecommendPage = () => {
  ...
  const aiEmpty = ai.length === 0;
  const categoryEmpty = categories.length === 0;
  ...
  return (
    <div className="w-full h-dvh bg-primary-50 pt-10 flex flex-col">
      ...
      >
        ...
        {isAI && (
          <div
            className="absolute bottom-27.5 left-1/2 -translate-x-1/2 flex gap-1.5 justify-center items-center px-6 py-3 bg-screen-0 border border-primary-50 rounded-4xl shadow-mini"
